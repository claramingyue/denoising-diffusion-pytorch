...
class Trainer:
    def __init__(
        ...
        *,
        ...
        assert (train_batch_size * gradient_accumulate_every) >= 8, f'your effective batch size (train_batch_size x gradient_accumulate_every) should be at least 16 or above'
