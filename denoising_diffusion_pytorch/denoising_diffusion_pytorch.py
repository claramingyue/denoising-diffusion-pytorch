...
# def Downsample(dim, dim_out=None):
#     return nn.Sequential(
#         Rearrange('b c (h p1) (w p2) -> b (c p1 p2) h w', p1=3, p2=3),  # Ahora agrupa en bloques de 3x3
#         nn.Conv2d(dim * 9, default(dim_out, dim), 1)  # Ajustar los canales (en lugar de *4, ahora es *9)
#     )
